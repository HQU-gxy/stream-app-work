...
void main() {
  group("venData parser", () {
    test("venData serialize", (){
      ...
      final val = VenData(mac1: "3323030949", mac2: "3323030927", speed: 0.52, distance: 40.2, angle: 51, isVentOn: true, mode: 1, isLightOpen: true);
    ...
    test("venData deserialize", (){
      ...
      final ex = VenData(mac1: "3323030949", mac2: "3323030927", speed: 0.52, distance: 40.2, angle: 51, isVentOn: true, mode: 1, isLightOpen: true);
